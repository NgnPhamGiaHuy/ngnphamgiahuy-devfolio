...
const MetricCard: React.FC<MetricCardProps> = ({
    ...
    return (
        ...
        >
            <span
                className={
                    "w-1/2 text-[37px] text-center font-bold leading-5 uppercase block"
                }
            >
                {value}
                {highlight && (
                    <strong
                        className={"top-[-4px] text-primary font-bold relative"}
                    >
                        &nbsp;{highlight}
                    </strong>
                )}
            ...
            <span
                className={
                    "w-1/2 text-[13px] text-left font-bold tracking-wider leading-5 uppercase block"
                }
            >
                {hasMultipleWords ? (
                    <>
