...
export { ProjectCard, ProjectGrid, ProjectCategoryFilter } from "./features/projects";
export { PlanCard, PlanGrid } from "./features/pricing";
...
// Re-export section components
export { PersonalIntro, BioSection, DecorativeLayer, ProfileVisual } from "./sections/profile";
